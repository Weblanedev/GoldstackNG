      ...
      <nav className="relative bg-white shadow dark:bg-gray-800">
        <div className="container flex items-center justify-between px-6 py-4 mx-auto">
          ...
          <div
            ...
            } absolute inset-x-0 top-[70px] z-20 w-full bg-white px-6 py-4 transition-all duration-300 ease-in-out dark:bg-gray-800 md:relative md:top-0 md:top-[unset] md:order-1 md:mt-0 md:flex md:w-auto md:translate-x-0 md:items-center md:bg-transparent md:p-0 md:opacity-100`}
          >
                      ...
                      <Link
                        ...
                        className={`${
                          currentCategory === category
                            ? "font-medium text-blue-500 dark:text-blue-500"
                            : "text-gray-700 dark:text-gray-200"
                        } my-2 transform capitalize transition-colors duration-300 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0`}
